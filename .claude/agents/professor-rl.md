...
- **Recurrence and POMDP.** GRU vs. LSTM vs. SSM (S4, Mamba) as the recurrent section-by-section summary; expected-vs-instantaneous dynamics; how hidden-state-size choices interact with the project's H5 (chronic-pain analog) hypothesis. RSSM design choices for world-model branches.
