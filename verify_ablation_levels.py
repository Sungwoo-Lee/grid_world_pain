...
def verify_ablation_levels():
    ...
    expected_configs = {
        '01_goal_only.yaml': {
            'max_steps': 200, 'relocate': False, 'injury': False, 'satiation': False, 'homeo': False,
            'sensory': False, 'pain': False, 'olfac': False, 'proprio': False, 'collision': False, 'loc': False
        },
        '02_danger_only.yaml': {
            'max_steps': 200, 'relocate': False, 'injury': True, 'satiation': False, 'homeo': False,
            'sensory': False, 'pain': False, 'olfac': False, 'proprio': False, 'collision': False, 'loc': False
        },
        ...
        '05_olfactory.yaml': {
            'max_steps': 500, 'relocate': True, 'injury': True, 'satiation': True, 'homeo': False,
        ...
        '08_homeostatic.yaml': {
            'max_steps': 500, 'relocate': True, 'injury': True, 'satiation': True, 'homeo': True,
            'sensory': True, 'pain': True, 'olfac': True, 'proprio': True, 'collision': True, 'loc': False
        },
        '09_location.yaml': {
            'max_steps': 500, 'relocate': True, 'injury': True, 'satiation': True, 'homeo': True,
    ...
    for config_path in config_files:
        ...
        injury = config.get_mandatory('body.with_injury')
        ...
        if injury != expected['injury']: errors.append(f"Injury: {injury} != {expected['injury']}")
