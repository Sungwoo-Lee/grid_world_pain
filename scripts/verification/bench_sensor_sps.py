...
CASES = [
    ...
    # --- DIRECTIONAL_SENSORS options, each measured against 'vision range 2, blur off' ---
    ({'sensory.visual_sensor_range': 2,
      'sensory.visual_value_mode': 'clamp'}, 'DIRECTIONAL_SENSORS clamp (presence)'),
    ({'sensory.visual_sensor_range': 2, 'sensory.visual_occlusion_enabled': True,
      'sensory.visual_occlusion_cone_deg': 5.0,
      'sensory.visual_occlusion_strength': 1.0}, 'DIRECTIONAL_SENSORS occlusion 5 deg'),
    ({'sensory.visual_sensor_range': 2, 'sensory.visual_occlusion_enabled': True,
      'sensory.visual_occlusion_cone_deg': 15.0,
      'sensory.visual_occlusion_strength': 1.0}, 'DIRECTIONAL_SENSORS occlusion 15 deg'),
    ({'sensory.visual_sensor_range': 2, 'sensory.visual_occlusion_enabled': True,
      'sensory.visual_occlusion_cone_deg': 15.0,
      'sensory.visual_occlusion_strength': 0.5}, 'DIRECTIONAL_SENSORS occlusion 15 deg, atten'),
    ({'sensory.visual_sensor_range': 2, 'sensory.visual_blur_enabled': True,
      ...
      'sensory.visual_occlusion_strength': 1.0}, 'DIRECTIONAL_SENSORS blur + clamp + occlusion'),
]
