...
L.record_samples("lad02_single_variable_steps", [
    dict(what="arms entering at least one pair", used=len(used_arms), total=POP["arms"],
    ...
    dict(what="episodes behind the 12 contrasts", used=len(used_arms) * 1_000_000,
         total=POP["episodes"], note="each contrast is two arms' full populations differenced")])
