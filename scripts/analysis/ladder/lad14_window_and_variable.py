...
L.record_samples("lad14_window_and_variable", [
    dict(what="step rows, panel A (first 25 steps)", used=_early, total=POP["steps"],
         note="the honest measurement"),
    dict(what="step rows, panel B (whole episode)", used=_all, total=POP["steps"],
         note="the same episodes, but every step of them - which is the whole point of the panel"),
    dict(what="step rows, panel C (whole episode)", used=_all, total=POP["steps"],
