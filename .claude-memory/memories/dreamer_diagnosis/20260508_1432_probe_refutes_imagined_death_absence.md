...
- Cell E3 — 00-NoPred + probe (`xekunmbw`, positive control, ran 7+ hr): img_h15 = 0.02 (low — episodes really long, MaxSteps=500), real_term = 105 steps. Survival 316, entropy 1.02, advantage **+0.005**. Probe tracks reality: low termination predictions track long real episodes. Confirms probe instrumentation works; isolates mechanism to predator-task dynamics.
