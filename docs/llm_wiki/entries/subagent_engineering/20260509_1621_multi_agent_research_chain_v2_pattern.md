...
- Project's broader append-only conventions: `docs/experiments/summaries/README.md` (re-summaries write fresh dated files); `docs/llm_wiki/CLAUDE.md` §11 (filename conventions).
