...
- `git reset --hard v1.4` brought the worktree branch tip to `07887e4` (the v1.4 tip at the start). The previously-untracked v2 design doc at `docs/develop/active/meta/llm_wiki_system_v2_design.md` survived the reset (only tracked files are touched by `--hard`).
