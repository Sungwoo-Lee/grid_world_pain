...
- Built `scripts/snapshot_code_graph.py <label>` to capture point-in-time copies into `docs/llm_wiki/code_snapshots/` (separate from the live gitignored output).
...
- v2 design doc, Feature 4c: [docs/develop/active/meta/llm_wiki_system_v2_design.md](../../../../docs/develop/active/meta/llm_wiki_system_v2_design.md)
