...
- Did NOT edit `docs/llm_wiki/entries/cluster_ops/20260508_1428_node_env_recovery_recipe.md` — the bare-ssh examples there implicitly use vncuser (the local user inside the container), which still routes correctly via the new `Match` block. No edit needed.
