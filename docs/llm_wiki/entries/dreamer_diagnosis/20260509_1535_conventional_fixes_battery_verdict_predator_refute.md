...
- Configs (1-line deltas each): `configs/models/dreamer_v3/dreamer_v3_rr06.yaml` (`replay_ratio: 0.5 → 0.0625`), `configs/experiment/dreamer_diagnostic/01-PredInterval3_NutGain18_DeathPenalty1.yaml` (`body.death_penalty: 100 → 1`).
