...
- **Rewrite procedure used** (and validated):
  1. `git show memorize-jaxvec-v1v2-v2:docs/llm_wiki/entries/dreamer_diagnosis/20260513_1417_jax_vmap_no_speedup_tiny_env.md > docs/llm_wiki/entries/dreamer_diagnosis/20260513_1417_jax_vmap_no_speedup_tiny_env.md` on the current base (v1.3 at `289ea54`). Verified content match via `git diff v1.3 memorize-jaxvec-v1v2-v2 -- docs/llm_wiki/entries/dreamer_diagnosis/20260513_1417_jax_vmap_no_speedup_tiny_env.md` returning empty.
...
- Insight file (single source of truth on v1.3 / develop / v1.4 now): [docs/llm_wiki/entries/dreamer_diagnosis/20260513_1417_jax_vmap_no_speedup_tiny_env.md](../../../docs/llm_wiki/entries/dreamer_diagnosis/20260513_1417_jax_vmap_no_speedup_tiny_env.md)
- Orphan-branch commit (now in reflog only): `36921aa` (was `memorize-jaxvec-v1v2-v2`)
- Related insight (wiki-write skill design rationale): [[20260508_0429_memorize_skill_design_and_ship]]
...
- `docs/llm_wiki/CLAUDE.md` operating manual sections 5 (insight template), 6 (fragmentation safeguards), 7 (raw archive — not relevant here, but the layer's overall doctrine)
