...
|---|---|---|---|---|
| 2026-06-19 01:15 | v3_config_system_overhaul | c62334f | 834 nodes / 1133 edges / 73 communities | [snapshot](20260619_0115_v3_config_system_overhaul.md) |
...
Snapshots are **immutable** once written — never edited, only superseded by newer snapshots. The `/wiki-write` skill optionally surfaces a snapshot candidate when the session involves 5 or more changed files in `src/`.
