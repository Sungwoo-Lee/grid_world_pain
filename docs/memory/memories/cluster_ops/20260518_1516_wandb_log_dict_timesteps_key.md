...
- [[20260529_1824_dreamer_srl_wandb_spread_and_config_save_parity]] (cluster_ops, 2026-05-29) — Lifted rPPO's `**config.to_dict()` spread pattern into dreamer_srl_main.py so th
