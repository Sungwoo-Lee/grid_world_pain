...
- Project's broader append-only conventions: `docs/experiments/summaries/README.md` (re-summaries write fresh dated files); `docs/memory/CLAUDE.md` §11 (filename conventions).
