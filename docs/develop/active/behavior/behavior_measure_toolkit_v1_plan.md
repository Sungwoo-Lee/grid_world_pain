...
> - Synthetic-test-trap lesson (load-bearing for verification): [`docs/llm_wiki/entries/subagent_engineering/20260509_1534_synthetic_smoke_masks_dict_assembly_bugs.md`](../../../../docs/llm_wiki/entries/subagent_engineering/20260509_1534_synthetic_smoke_masks_dict_assembly_bugs.md).
...
This is the explicit avoidance lesson from [`20260509_1534_synthetic_smoke_masks_dict_assembly_bugs`](../../../../docs/llm_wiki/entries/subagent_engineering/20260509_1534_synthetic_smoke_masks_dict_assembly_bugs.md). The senior-developer:
...
- **Synthetic-test-trap insight** (`docs/llm_wiki/entries/subagent_engineering/20260509_1534_synthetic_smoke_masks_dict_assembly_bugs.md`) — the load-bearing verification protocol rule that requires real-`train.py` smoke output, not a standalone script.
