...
> **Fix plan:** [[FIX_TRUNCATION_TREATED_AS_DEATH]] (`docs/develop/active/issues/FIX_TRUNCATION_TREATED_AS_DEATH.md`) — Part 1 (death penalty on real death only, in `core.py`) + Part 2 (GAE truncation bootstrap). Part 1 implemented; Part 2 deferred pending a separate user decision.
>
