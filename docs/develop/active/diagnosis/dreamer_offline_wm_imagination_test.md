...
> - **Memory insights**:
>   - [`docs/llm_wiki/entries/dreamer_diagnosis/20260508_1432_probe_refutes_imagined_death_absence.md`](../../../../docs/llm_wiki/entries/dreamer_diagnosis/20260508_1432_probe_refutes_imagined_death_absence.md) — refutes "WM cannot imagine death"; new working hypothesis is "imagined deaths are miscalibrated in time and per-action".
>   - [`docs/llm_wiki/entries/dreamer_diagnosis/20260508_1431_diagnostic_battery_refutes_four_fixes.md`](../../../../docs/llm_wiki/entries/dreamer_diagnosis/20260508_1431_diagnostic_battery_refutes_four_fixes.md) — four ranked fixes refuted.
